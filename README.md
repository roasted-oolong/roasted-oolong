...
## 🌐 My Coding Projects:
- [Members-Only Rails Auth](https://github.com/roasted-oolong/members-only-rails-auth)
- [Data Structures in Ruby](https://github.com/roasted-oolong/data-structures-ruby)
- [Photo Search Rails API](https://github.com/roasted-oolong/photo-search-rails-api)
- [Astro Blog](https://github.com/roasted-oolong/astro-blog)
- [Multi-Agent AI Startup Analysis](https://github.com/roasted-oolong/multi-agent-ai-startup-analysis)
